...
MY_MPESA_PAYBILL_NUMBER = config('MY_MPESA_ACCOUNT_NUMBER_B')
MPESA_PASSKEY_B = config('MPESA_PASSKEY_B')
MPESA_INITIATOR_USERNAME_B = config('MPESA_INITIATOR_USERNAME_B')
MPESA_INITIATOR_SECURITY_CREDENTIAL_B = config('MPESA_INITIATOR_SECURITY_CREDENTIAL')
